                ...
                <div className="mt-auto pt-2 sm:pt-4">
                    ...
                    <div className="flex gap-1 sm:gap-2">
                        <button
                            ...
                            className="flex-1 py-1 sm:py-2.5 bg-slate-50 text-slate-600 border border-slate-100 text-[8px] sm:text-sm font-bold uppercase tracking-wider rounded-lg sm:rounded-xl hover:bg-slate-100 active:scale-95 transition-all flex items-center justify-center gap-1.5"
                        >
                        ...
                        <button
                            ...
                            className="flex-1 py-1 sm:py-2.5 bg-slate-900 text-white text-[8px] sm:text-sm font-bold uppercase tracking-wider rounded-lg sm:rounded-xl hover:bg-blue-600 active:scale-95 transition-all shadow-lg shadow-slate-900/10"
                        >
